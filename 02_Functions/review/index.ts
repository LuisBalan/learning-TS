function useMagnifyingGlass(): string{
  ...
  function doSleuthing(numberOfClues:number, clue1:string, clue2:string, suspect1:string, suspect2:number):any{
    console.log('I am a famous detective and I will solve the crime.');
    let unnecessaryVariable: string = 'Why is this here?'
  ...
  answer=doSleuthing(2, 'The parrot heard everything!', 'All the doors and windows were shut from the INSIDE.', 'Burglar Bob', 2)
